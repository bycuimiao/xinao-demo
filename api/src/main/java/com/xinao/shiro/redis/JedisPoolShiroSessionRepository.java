...
import com.xinao.shiro.session.CustomSessionManager;
import com.xinao.shiro.session.SessionStatus;
...
public class JedisPoolShiroSessionRepository implements ShiroSessionRepository {
  ...
  public void saveSession(Session session) {
    ...
    try {
      ...
      jedis.set(key,value);
      jedis.close();
      //MyJedisPool.getJedis().set(key,value);
  ...
  public void deleteSession(Serializable id) {
    ...
    try {
      Jedis jedis = MyJedisPool.getJedis();
      jedis.del(SerializeUtil.serialize(buildRedisSessionKey(id)));
      jedis.close();
    } catch (Exception e) {
